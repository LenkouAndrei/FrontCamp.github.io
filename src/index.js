window.onload = function() {
  ...
  class NavigationButton extends CommonElement {
  ...
  class ElementContainer extends CommonElement {
    ...
    createInnerElement({ value, active }) {
      ...
      if (active && !value.title) {
        this.activeButton = innerElement.htmlElement
      }
      return innerElement.htmlElement
    }
  ...
  navigation
    ...
    .then(() => {
      ...
      navigation.height = mainContainerHeight
      navigation.applyHeightToHTMLElement()
      navigation.innerElementsList.forEach(button => {
        const buttonHTML = button.htmlElement
        buttonHTML.addEventListener('click', () => {
          navigation.activeButton.classList.remove('active')
          buttonHTML.classList.add('active')
          navigation.activeButton = buttonHTML
